...
/**
 * A test class for testing QuickSort algorithm
 * @author Anara
 */
public class QuickSortTest {
     ...
     * method quickSort taken from the Submenu to implement the comparator from there to here and be able to test the String array
     */
    @Test
    ...
    /**
     * numbers are sorted in form of String
     */
    @Test
    ...
    /**
     * method to see why it fails if it fails
     * @param input given array
     * @param expected array
     * @param <T> type of sorted items in the array
     */
    private <T> void assertArrayEquals(T[] input, T[] expected) {
        if (!Arrays.equals(input, expected)){
            fail("the two arrays are not equal.\n" +
                    ...
                    "actual:" + Arrays.deepToString(input));
        }
    }
}
