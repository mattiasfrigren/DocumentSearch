...
public class BubbleSort {
    ...
    // T is a place holder for the class

    public <T> void sort (T[] array, Comparator<T> comparator) { //Comparator - Interface, the result of it is if to compare equal it returns 0
    ...
    private <T> boolean isWrongOrder(T first, T second, Comparator<T> comparator) {
        ...
        return comparator.compare(first, second) > 0; //method "compare"
    }
